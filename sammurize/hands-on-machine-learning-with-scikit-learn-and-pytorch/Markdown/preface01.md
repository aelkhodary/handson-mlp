...
![Diagram illustrating the dependencies between chapters in a machine learning book, showing which chapters must be read first before others.](./Images/hmls_0001.png)
...
* Andrew Ng’s *Machine Learning Yearning* is a free ebook that provides a thoughtful exploration of machine learning, focusing on the practical considerations of building and deploying models, including data quality and long-term
  maintenance.
...
team—particularly Beth Kelly and Kristen Brown—who did a remarkable job. I want to acknowledge Sonia Saruba for her countless careful copyedits, Kate Dullea for making my diagrams much prettier, and Susan Thompson for the beautiful orangutan on the cover.
